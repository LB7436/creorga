...
const WORDS: string[] = [
  ...
  'VITRE','VOGUE','VOTER','VOUER','VOYOU','WAGON','ZESTE','ZEBRE',
  // Extension curée : vrais mots français de 5 lettres, sans accents (clavier A-Z).
  'ADIEU','AGENT','AIDES','AILES','AINES','ALLEE','ALPIN','APPAS','ARMEE','ASSEZ',
  'AUBES','AUTRE','BACHE','BADGE','BALAI','BANCS','BARDA','BASSE','BEBES','BENIR',
  'BERCE','BICHE','BIERE','BIJOU','BONTE','BOTTE','BOXER','BRUIT','BUTTE','CALER',
  'CANNE','CANOE','CARIE','CAVES','CEDER','CELLE','CHOIX','CIRER','CIVET','CLOWN',
  'CODER','COING','COLIS','COMTE','CORNE','COTES','COUDE','CRABE','CRAIE','CROIX',
  'CUBES','CURER','DATTE','DEBAT','DECOR','DELAI','DEMON','DIGNE','DINDE','DINER',
  'DOTER','DUNES','ECHOS','ECOLE','EGARE','ELANS','ELEVE','ELIRE','ENGIN','ENJEU',
  'ENNUI','ENTRE','EPARS','EPEES','EPINE','ERGOT','ESSAI','ETAUX','ETIRE','EXILS',
  'FABLE','FACES','FADES','FAGOT','FAIRE','FANES','FARCE','FAUNE','FAUTE','FELIN',
  'FENTE','FERME','FETES','FIBRE','FICHE','FIGUE','FILET','FINIR','FLANC','FLEUR',
  'FLUTE','FONTE','FOSSE','FOULE','FRISE','FROID','FRUIT','FUMEE','FUMER','GAGES',
  'GALOP','GANTS','GARER','GEANT','GELER','GENES','GESTE','GOMME','GOSSE','GOUTS',
  'GRAND','GRELE','GRIVE','GUEPE','GUEUX','HAIES','HERBE','HERON','HIBOU','HONTE',
  'HUILE','HUTTE','IDEAL','IDOLE','ILOTS','INDEX','ISSUE','JATTE','JAUNE','JETON',
  'JOIES','JOUES','JOUET','JUPES','JURER','LACER','LACET','LAINE','LAITS','LAMES',
  'LARME','LATTE','LEGER','LESER','LILAS','LIMES','LISSE','LISTE','LITRE','LOBES',
  'LOTIR','LOUPS','LUIRE','LUNES','MACON','MAINS','MAIRE','MALLE','MANGE','MARDI',
  'MARIN','MEDIA','MELON','MERES','MESSE','METAL','MEUTE','MICRO','MINCE','MINES',
  'MITES','MOCHE','MODES','MOTIF','MOUES','MURES','MUSEE','NAGER','NAINE','NEIGE',
  'NERFS','NIECE','NOEUD','NOIRE','NOTER','NOYAU','NUAGE','NUQUE','OCRES','OEUFS',
  'OISON','OMBRE','ORDRE','OTAGE','OUBLI','OURSE','OUTIL','OVALE','PACHA','PAGES',
  'PANDA','PAPES','PARIS','PARMI','PATES','PEINE','PELLE','PENTE','PERCE','PERIL',
  'PESER','PETRI','PEURS','PIANO','PILER','PILON','PINTE','PLAIE','PLAIT','PLATS',
  'POIDS','POILS','POIRE','PONTS','PORTE','POSER','POULE','PRETS','PRIER','PUCES',
  'PUITS','QUAIS','QUOTA','RABAT','RACES','RADIS','RAFLE','RAGES','RAIDE','RAMER',
  'RAPES','RATES','RAVIN','REGIE','REGNE','RENES','RENNE','RETIF','REVES','RHUME',
  'RIDES','RIRES','RIVES','ROLES','RONDE','ROSES','ROUES','ROUTE','RUCHE','RUGBY',
  'RUSER','SABRE','SACRE','SAGES','SAINE','SALLE','SALON','SALVE','SANGS','SAUCE',
  'SAULE','SAUTE','SAVON','SCENE','SEAUX','SECTE','SEINS','SELLE','SEMER','SENAT',
  'SERPE','SEUIL','SIEGE','SIGNE','SINGE','SITES','SOCLE','SOIES','SONGE','STADE',
  'SUCRE','SUEUR','SUITE','TABLE','TACHE','TALON','TAMIS','TANTE','TARTE','TASSE',
  'TATER','TAULE','TEMPO','TENIR','TETES','TIARE','TIGES','TIGRE','TOMES','TONNE',
  'TOPER','TOTAL','TRACE','TRAME','TRIBU','TUBES','TUNER','TUYAU','USAGE','USINE',
  'VACHE','VAGUE','VALSE','VANNE','VEINE','VELUE','VENTE','VERBE','VERRE','VERTS',
  'VEUVE','VIGNE','VILLE','VIRER','VISER','VIVRE','VOEUX','VOILE','VOLER','VOTES',
  'ZONES','ZOOMS',
]
