...
const WORD_BANK: Word[] = [
  ...
  { w: 'CAMELEON', h: 'Reptile qui change de couleur', cat: 'Animaux' },
  ...
  { w: 'CHAMPIGNON', h: 'Cepe, girolle ou bolet', cat: 'Nourriture' },
  ...
  { w: 'KALEIDOSCOPE', h: 'Tube aux reflets colorés', cat: 'Objets' },
