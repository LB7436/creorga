...
export const GUEST_GAMES: GuestGameDef[] = [
  ...
  { id: 'erreur11', name: 'Erreur 11 Terrasse', icon: '👁️', categories: ['reflexion', 'multi'], description: 'Trouver 11 différences dans une scène restaurant arbre et tour', estTime: '5 min', difficulty: 2, rating: 4.6, new: true, available: false },
  ...
  { id: 'run21', name: 'Run 21 Creorga', icon: '🃏', categories: ['cartes', 'arcade'], description: 'Cartes arcade: 5 colonnes, objectif 21, bonus parfait', estTime: '6 min', difficulty: 2, rating: 4.5, new: true, available: false },
  { id: 'tritowers', name: 'Tri-Tours Neon', icon: '⛰️', categories: ['cartes', 'arcade'], description: 'Solitaire rapide: montez ou descendez pour vider les tours', estTime: '7 min', difficulty: 2, rating: 4.5, new: true, available: false },
