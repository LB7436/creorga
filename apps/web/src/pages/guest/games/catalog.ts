...
export const GUEST_GAMES: GuestGameDef[] = [
  { id: 'chess', name: 'Échecs', icon: '♟️', categories: ['classiques', 'reflexion'], description: 'IA tactique, coups légaux, vraie pression de fin de partie', estTime: '15 min', difficulty: 3, rating: 4.8, hot: true, available: true },
  { id: 'solitaire', name: 'Solitaire', icon: '🂡', categories: ['classiques', 'cartes'], description: 'Klondike tactile avec annulation et auto-move', estTime: '10 min', difficulty: 2, rating: 4.6, available: true },
  { id: 'memory', name: 'Memory', icon: '🔮', categories: ['classiques'], description: 'Paires, rythme court et parfait pendant l’attente', estTime: '5 min', difficulty: 1, rating: 4.5, available: true },
  { id: 'blackjack', name: 'Blackjack', icon: '🃏', categories: ['cartes', 'casino'], description: 'Croupier CPU, mises fictives et partie rapide', estTime: '8 min', difficulty: 2, rating: 4.7, hot: true, available: true },
  { id: 'poker', name: "Poker Hold'em", icon: '♠️', categories: ['cartes', 'casino'], description: "Texas Hold'em contre CPU avec mains lisibles", estTime: '12 min', difficulty: 3, rating: 4.9, new: true, available: true },
  { id: 'bataille', name: 'Bataille', icon: '⚔️', categories: ['cartes', 'multi'], description: 'Cartes rapides, parfait à deux autour de la table', estTime: '7 min', difficulty: 1, rating: 4.2, available: true },
  ...
  { id: 'towerdefense', name: 'Tower Defense', icon: '🗼', categories: ['arcade'], description: "5 vagues, tours, économie et tension lisible", estTime: '15 min', difficulty: 3, rating: 4.6, new: true, available: true },
  { id: 'ttt', name: 'Morpion', icon: '✖️', categories: ['classiques', 'multi'], description: 'Duel instantané, idéal pour enfants et familles', estTime: '3 min', difficulty: 1, rating: 4.1, available: true },
  { id: 'connect4', name: 'Puissance 4', icon: '🔴', categories: ['multi'], description: 'Duel clair, jetons tactiles, lecture immédiate', estTime: '6 min', difficulty: 2, rating: 4.5, available: true },
  { id: 'reversi', name: 'Reversi', icon: '⭕', categories: ['reflexion', 'multi'], description: 'Othello mobile avec IA et choix de niveau', estTime: '10 min', difficulty: 2, rating: 4.3, available: true },
  ...
  { id: 'bingo', name: 'Bingo', icon: '🎱', categories: ['casino', 'multi'], description: 'Grille claire et tirages rapides', estTime: '10 min', difficulty: 1, rating: 4.2, available: true },
  { id: 'scoopa', name: 'Scoopa 3D', icon: '🃏', categories: ['cartes', 'multi'], description: 'Scopa italienne premium: captures, Denari, Primiera et table 3D', estTime: '12 min', difficulty: 2, rating: 4.8, new: true, available: true },
  { id: 'mensch', name: 'Petits Chevaux 3D', icon: '🔴', categories: ['classiques', 'multi'], description: 'Regles type Mensch/Ludo: sortir sur 6, captures, arrivee exacte et duel de table', estTime: '15 min', difficulty: 1, rating: 4.7, new: true, available: true },
  { id: 'basket3d', name: 'Basket Rooftop 3D', icon: '🏀', categories: ['arcade', 'multi'], description: 'Timing de tir, panier lumineux, série bonus et décor rooftop', estTime: '3 min', difficulty: 1, rating: 4.7, new: true, available: true },
  { id: 'mahjong3d', name: 'Mahjong Bamboo 3D', icon: '🀄', categories: ['reflexion'], description: 'Paires de tuiles ouvertes, ambiance bambou, parties courtes', estTime: '6 min', difficulty: 1, rating: 4.6, new: true, available: true },
  { id: 'erreur11', name: 'Erreur 11 Terrasse', icon: '👁️', categories: ['reflexion', 'multi'], description: 'Trouver 11 différences dans une scène restaurant arbre et tour', estTime: '5 min', difficulty: 2, rating: 4.6, new: true, available: true },
  { id: 'billard', name: 'Billard Lounge 3D', icon: '🎱', categories: ['arcade', 'multi'], description: 'Pool tactile, ordre des billes, dosage de puissance', estTime: '7 min', difficulty: 2, rating: 4.7, new: true, available: true },
  { id: 'run21', name: 'Run 21 Creorga', icon: '🃏', categories: ['cartes', 'arcade'], description: 'Cartes arcade: 5 colonnes, objectif 21, bonus parfait', estTime: '6 min', difficulty: 2, rating: 4.5, new: true, available: true },
  { id: 'tritowers', name: 'Tri-Tours Neon', icon: '⛰️', categories: ['cartes', 'arcade'], description: 'Solitaire rapide: montez ou descendez pour vider les tours', estTime: '7 min', difficulty: 2, rating: 4.5, new: true, available: true },
  { id: 'rami', name: 'Rami Salon 3D', icon: '🃏', categories: ['cartes', 'multi'], description: 'Rami jouable en mode normal ou sortie 40', estTime: '12 min', difficulty: 2, rating: 4.8, new: true, available: true },
  { id: 'rummikub', name: 'Rummi Kub 3D', icon: '🧩', categories: ['classiques', 'reflexion', 'multi'], description: 'Tuiles brillantes, groupes, suites et chevalet tactile', estTime: '12 min', difficulty: 2, rating: 4.8, new: true, available: true },
