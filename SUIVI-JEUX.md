...
- [ ] Reste (enhancements, aucun bug) : polish (états vides, accents FR épars), Web Worker IA échecs, réarrangement libre table Rummikub (split/recombine), IA qui exploite la manipulation de table
